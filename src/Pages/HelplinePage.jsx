...
function StatusCard({ title, icon, iconStyle, items }) {
  return (
    <div className="flex h-full flex-col rounded-xl border border-[#c4c6cf] bg-white p-6 shadow-sm">
      ...
      <div className="mb-4 flex items-start gap-4 border-b border-[#c4c6cf] pb-4">
        <div
          className={`flex-shrink-0 rounded-lg p-3 ${iconStyle}`}
        >
          <span className="material-symbols-outlined">
            {icon}
          </span>
          ...
          >
            <div>
              ...
              <div className="mt-1 flex items-center gap-2">
                <div
                  className={`h-2 w-2 rounded-full ${shelter.color}`}
                />
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="relative flex h-[400px] flex-col overflow-hidden rounded-xl border border-[#c4c6cf] bg-white shadow-sm">
                  ...
                  <div className="relative flex-grow bg-[#dad9dd]">
                    ...
                    <img
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuDim3YqSjS8Ducf1aC_ON9YkJK12lTgRym9jyCQ3B0tuWtWRUKzO6gZnAJJXwp_q6qBhXQkCYqJXEpRp_cMlJZRkvqn11Pq440VQPMiAkH-yt-ZEzxgCZp33mF3XGqgP6x7HZqK2DEvySoYBAwW0BV9AD6awnR-mkmDPBpE35jWnFB947iS7bj27NieDXx3XX11t5HvG8bAi5eOe-pRJI2OWs25WzW9pO_2Xr7zkdzCk5JxUi6L5CSD"
                      alt="Regional relief map showing relief shelters and safe zones"
                    ...
                    <div className="absolute right-4 top-4 flex flex-col gap-2">
                      ...
                      <button
                        type="button"
                        className="flex h-8 w-8 items-center justify-center rounded border border-[#c4c6cf] bg-white text-[#002045] shadow-sm hover:bg-[#e3e2e6]"
                      >
                        <span className="material-symbols-outlined text-[20px]">
                          add
                        </span>
                      ...
                      <button
                        type="button"
                        className="mt-2 flex h-8 w-8 items-center justify-center rounded border border-[#c4c6cf] bg-white text-[#002045] shadow-sm hover:bg-[#e3e2e6]"
                      >
                        <span className="material-symbols-outlined text-[20px]">
                          my_location
                        </span>
